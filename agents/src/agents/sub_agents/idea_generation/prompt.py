...
INSTRUCTIONS = """
1. Understand the user's goal and utilize information you get from user (X account posting, trending, etc..)
2. Analyze if the information is enough to generate ideas. If not, choose search query and use your `google_search` tool to get more information.
...
4. Start generating ideas to maximize user engagment. Follow the following steps:
    ...
    (3). Third, generate 1-2 sentence of text (text_prompt) as a title or sort comment for the post.
